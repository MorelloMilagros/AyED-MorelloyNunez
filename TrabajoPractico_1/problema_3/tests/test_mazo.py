...
from modules.clases import Mazo
import unittest
...
class TestMazo(unittest.TestCase):
    ...
    def test_poner_carta_arriba(self):            #Poner arriba al momento de repartir las cartas, sacar arriba al momento de jugar el turno
    ...
    def test_poner_carta_abajo(self):                     #Poner abajo al momento de ganar el turno
        carta1=Carta('5','trebol')
        carta2=Carta('3','corazones')
